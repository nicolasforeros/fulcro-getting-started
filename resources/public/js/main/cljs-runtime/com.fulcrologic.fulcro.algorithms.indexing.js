...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__50413){
var map__50414 = p__50413;
var map__50414__$1 = cljs.core.__destructure_map(map__50414);
var ast = map__50414__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50414__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50414__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__50415){
var map__50416 = p__50415;
var map__50416__$1 = cljs.core.__destructure_map(map__50416);
var child_ast = map__50416__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50416__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50416__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50416__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__50417 = idx;
var G__50417__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__50417,dispatch_key,parent_key):G__50417);
var G__50417__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__50417__$1,key,parent_key):G__50417__$1);
var G__50417__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__50417__$2,key,parent_key):G__50417__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__50417__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__50417__$3,child_ast));
} else {
return G__50417__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50430__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__50432){
var map__50433 = p__50432;
var map__50433__$1 = cljs.core.__destructure_map(map__50433);
var ast = map__50433__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50433__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50433__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,1304105472,null);

var map__50439 = app__$1;
var map__50439__$1 = cljs.core.__destructure_map(map__50439);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50439__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50439__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__50440 = cljs.core.deref(runtime_atom);
var map__50440__$1 = cljs.core.__destructure_map(map__50440);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50440__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__50459 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__50459__$1 = cljs.core.__destructure_map(map__50459);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50459__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__50493 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__50493__$1 = cljs.core.__destructure_map(map__50493);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50493__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__50516){
var map__50517 = p__50516;
var map__50517__$1 = cljs.core.__destructure_map(map__50517);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50517__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__50519_50590 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__50520_50591 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__50520_50591);
...
}),null)),null,1971263782,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__50519_50590);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__50529 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__50530 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__50530);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__50529);
}})], null);
}));
