...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__53230){
var map__53231 = p__53230;
var map__53231__$1 = cljs.core.__destructure_map(map__53231);
var ast = map__53231__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53231__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53231__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__53237){
var map__53238 = p__53237;
var map__53238__$1 = cljs.core.__destructure_map(map__53238);
var child_ast = map__53238__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53238__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53238__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53238__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__53241 = idx;
var G__53241__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__53241,dispatch_key,parent_key):G__53241);
var G__53241__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__53241__$1,key,parent_key):G__53241__$1);
var G__53241__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__53241__$2,key,parent_key):G__53241__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__53241__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__53241__$3,child_ast));
} else {
return G__53241__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53248__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__53250){
var map__53251 = p__53250;
var map__53251__$1 = cljs.core.__destructure_map(map__53251);
var ast = map__53251__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53251__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53251__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var map__53257 = app__$1;
var map__53257__$1 = cljs.core.__destructure_map(map__53257);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53257__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53257__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__53258 = cljs.core.deref(runtime_atom);
var map__53258__$1 = cljs.core.__destructure_map(map__53258);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53258__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__53267 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__53267__$1 = cljs.core.__destructure_map(map__53267);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53267__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__53281 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__53281__$1 = cljs.core.__destructure_map(map__53281);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53281__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__53306){
var map__53307 = p__53306;
var map__53307__$1 = cljs.core.__destructure_map(map__53307);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53307__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__53308_53349 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__53309_53350 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__53309_53350);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__53308_53349);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__53316 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__53317 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__53317);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__53316);
}})], null);
}));
