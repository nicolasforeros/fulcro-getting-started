...
var map__28893 = top_item;
var map__28893__$1 = cljs.core.__destructure_map(map__28893);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28893__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28893__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28893__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28892){var _e = e28892;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___28957 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___28957)){
var seen_errors_28958 = temp__5802__auto___28957;
if(cljs.core.truth_(seen_errors_28958.has(self))){
} else {
seen_errors_28958.add(self);

var temp__5804__auto___28960 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___28960)){
var sense_28964 = temp__5804__auto___28960;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28964)].join(''));
} else {
}
}
} else {
