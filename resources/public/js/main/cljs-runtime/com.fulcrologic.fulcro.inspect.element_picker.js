...
var G__46919 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__46919,"id",id);

goog.dom.appendChild(document.body,G__46919);
...
var G__46921 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__46921,"id",id);

goog.dom.appendChild(document.body,G__46921);
...
var temp__5802__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46922_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__46922_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__46922_SHARP_,"__reactFiber$")));
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__46926){
var map__46927 = p__46926;
var map__46927__$1 = cljs.core.__destructure_map(map__46927);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46927__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__46940 = target__$1;
if((G__46940 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__46940);
}
})();
...
var G__47049 = goog.dom.getParentElement(target__$1);
target__$1 = G__47049;
continue;
}
} else {
...
var G__46969_47054 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__46969_47054) : on_pick.call(null,G__46969_47054));
...
var state_map = (function (){var G__46976 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__46976__$1 = (((G__46976 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__46976));
if((G__46976__$1 == null)){
return null;
} else {
return cljs.core.deref(G__46976__$1);
}
})();
...
}catch (e46977){var _ = e46977;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__46979 = comp;
var G__46979__$1 = (((G__46979 == null))?null:com.fulcrologic.fulcro.components.react_type(G__46979));
if((G__46979__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__46979__$1);
}
}catch (e46978){var _ = e46978;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__46981 = comp;
var G__46981__$1 = (((G__46981 == null))?null:com.fulcrologic.fulcro.components.react_type(G__46981));
if((G__46981__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__46981__$1,state_map);
}
}catch (e46980){var _ = e46980;
return null;
}})()], null);
});
/**
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46991__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
