...
var G__50543 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__50543,"id",id);

goog.dom.appendChild(document.body,G__50543);
...
var G__50546 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__50546,"id",id);

goog.dom.appendChild(document.body,G__50546);
...
var temp__5802__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50547_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__50547_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__50547_SHARP_,"__reactFiber$")));
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__50559){
var map__50560 = p__50559;
var map__50560__$1 = cljs.core.__destructure_map(map__50560);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50560__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__50561 = target__$1;
if((G__50561 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__50561);
}
})();
...
var G__50583 = goog.dom.getParentElement(target__$1);
target__$1 = G__50583;
continue;
}
} else {
...
var G__50566_50584 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__50566_50584) : on_pick.call(null,G__50566_50584));
...
var state_map = (function (){var G__50567 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__50567__$1 = (((G__50567 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__50567));
if((G__50567__$1 == null)){
return null;
} else {
return cljs.core.deref(G__50567__$1);
}
})();
...
}catch (e50572){var _ = e50572;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__50574 = comp;
var G__50574__$1 = (((G__50574 == null))?null:com.fulcrologic.fulcro.components.react_type(G__50574));
if((G__50574__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__50574__$1);
}
}catch (e50573){var _ = e50573;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__50576 = comp;
var G__50576__$1 = (((G__50576 == null))?null:com.fulcrologic.fulcro.components.react_type(G__50576));
if((G__50576__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__50576__$1,state_map);
}
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50578__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
