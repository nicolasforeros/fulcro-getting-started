...
var i_37584 = (0);
while(true){
if((i_37584 < arr.length)){
(arr[i_37584] = null);

var G__37585 = (i_37584 + (1));
i_37584 = G__37585;
continue;
} else {
}
...
var i_37596 = (self__.level + (1));
while(true){
if((i_37596 <= (new_level + (1)))){
(update[i_37596] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_37600 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_37600[i]));
} else {
x__$2.forward.push((((i < links_37600.length))?(links_37600[i]):null));
}

if((i < links_37600.length)){
(links_37600[i] = x__$2);
} else {
links_37600.push(x__$2);
}
...
var i_37609 = (0);
while(true){
if((i_37609 <= self__.level)){
var links_37610 = (update[i_37609]).forward;
if((x__$1 === (((i_37609 < links_37610.length))?(links_37610[i_37609]):null))){
(links_37610[i_37609] = (x__$1.forward[i_37609]));

var G__37611 = (i_37609 + (1));
i_37609 = G__37611;
continue;
} else {
var G__37612 = (i_37609 + (1));
i_37609 = G__37612;
continue;
}
} else {
...
var G__37618 = nx;
var G__37619 = (level__$1 - (1));
x = G__37618;
level__$1 = G__37619;
continue;
} else {
var G__37620 = x;
var G__37621 = (level__$1 - (1));
x = G__37620;
level__$1 = G__37621;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__37624 = nx;
var G__37625 = (level__$1 - (1));
x = G__37624;
level__$1 = G__37625;
continue;
} else {
var G__37626 = x;
var G__37627 = (level__$1 - (1));
x = G__37626;
level__$1 = G__37627;
continue;
}
