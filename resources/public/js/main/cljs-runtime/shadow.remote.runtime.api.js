...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45943 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45943(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_45946 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_45946(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_45948 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_45948(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_45950 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_45950(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45954 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45954(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45956 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45956(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__45934,callback){
var map__45935 = p__45934;
var map__45935__$1 = cljs.core.__destructure_map(map__45935);
var input = map__45935__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45935__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45935__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
