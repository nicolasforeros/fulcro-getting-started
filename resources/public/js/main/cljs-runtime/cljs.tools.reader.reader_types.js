...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_32436 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_32436(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_32440 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_32440(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32441 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32441(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_32442 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_32442(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_32443 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_32443(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32449 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32449(reader);
}
});
...
var G__32495 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__32496 = s.append(c);
c = G__32495;
s = G__32496;
continue;
}
