...
var id = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48736_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__48736_SHARP_);
}),tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48737_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__48737_SHARP_);
}),tokens);
...
var G__48742 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48742,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__48742;
}
} else {
...
var map__48753 = com.fulcrologic.fulcro.dom_common.parse(kw);
var map__48753__$1 = cljs.core.__destructure_map(map__48753);
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48753__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48753__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__48759 = (function (){var or__5045__auto__ = props;
...
var G__48759__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48759,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__48759);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48759__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__48759__$1;
}
}
