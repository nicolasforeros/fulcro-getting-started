...
var map__47375 = app__$1;
var map__47375__$1 = cljs.core.__destructure_map(map__47375);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47375__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var raf_47410 = (((typeof requestAnimationFrame !== 'undefined'))?requestAnimationFrame:(function (p1__47381_SHARP_){
return com.fulcrologic.fulcro.algorithms.scheduling.defer(p1__47381_SHARP_,(16));
}));
/**
...
var map__47383 = app__$1;
var map__47383__$1 = cljs.core.__destructure_map(map__47383);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47383__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(runtime_atom),scheduled_key))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(runtime_atom,cljs.core.assoc,scheduled_key,true);
...
return (raf_47410.cljs$core$IFn$_invoke$arity$1 ? raf_47410.cljs$core$IFn$_invoke$arity$1(f) : raf_47410.call(null,f));
}
});
